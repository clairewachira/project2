...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$query = "INSERT INTO pharmacy (name, location, email_address, phone_number)
		VALUES ('$name', '$location', '$email_address', '$phone_number')";

	if ($mysqli->query($query) === TRUE) {
		$registration_success = true;
	} else {
		$_SESSION["error_message"] = "Pharmacy registration failed. Please try again later.";
	}
}
...
if ($registration_success) {
	echo '<div class="alert alert-success">Pharmacy registration successful!</div>';
}
?>

    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
	<!-- Add form fields for pharmacy registration -->
